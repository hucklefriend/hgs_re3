...
use App\Http\Requests\Admin\Game\GameFranchiseTitleLinkRequest;
...
class GameFranchiseController extends AbstractAdminController
{
     ...
     * @return RedirectResponse
     */
    public function syncTitle(LinkMultiGameTitleRequest $request, GameFranchise $franchise): RedirectResponse
    {
