...
@section('content')
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('Admin.Game.RelatedProduct.JsonDiff', $model) }}">
                @csrf
        ...
        <div class="panel-footer">
            ...
            <a href="{{ route('Admin.Game.RelatedProduct.JsonExport', $model) }}" class="btn btn-default">JSON出力へ</a>
        </div>
    </div>
@endsection
