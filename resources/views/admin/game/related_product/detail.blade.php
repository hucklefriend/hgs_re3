...
@section('content')
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            <div class="text-end">
                <a href="{{ route('Admin.Game.RelatedProduct.JsonExport', $model) }}" class="btn btn-default">
                    <i class="fas fa-file-export"></i><span class="d-none d-md-inline"> JSON出力</span>
                </a>
                <a href="{{ route('Admin.Game.RelatedProduct.JsonImport', $model) }}" class="btn btn-default">
