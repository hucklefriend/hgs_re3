...
@section('content')
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title">関連商品 - JSONから新規作成</h4>
        </div>
        <div class="panel-body">
            <p class="text-muted">
                下記のひな形JSONをAI（ChatGPT・Claude・Geminiなど）に渡し、新規作成したい
                関連商品・ショップの内容を埋めてもらってください。
            ...
            <form method="POST" action="{{ route('Admin.Game.RelatedProduct.JsonNewDiff') }}">
                @csrf
        ...
        <div class="panel-footer">
            <a href="{{ route('Admin.Game.RelatedProduct') }}" class="btn btn-default"><i class="fas fa-arrow-left"></i> 一覧へ戻る</a>
        </div>
    </div>
@endsection
