...
@section('content')
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            <form action="{{ route('Admin.Game.Franchise.EditMulti') }}" method="GET">
                <div class="row mb-3">
                    <label class="form-label col-form-label col-md-3">Name</label>
                    <div class="col-md-9">
                        <input type="text" name="name" class="form-control" placeholder="名前 or よみがな(半角スペースで単語区切り)" value="{{ $search['name'] ?? ''}}" autocomplete="off">
                    </div>
                </div>
                <div class="row">
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('Admin.Game.Franchise.UpdateMulti', $search) }}">
                @csrf
                {{ method_field('PUT') }}
