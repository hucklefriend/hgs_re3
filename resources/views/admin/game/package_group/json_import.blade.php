...
@section('content')
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('Admin.Game.PackageGroup.JsonDiff', $model) }}">
                @csrf
        ...
        <div class="panel-footer">
            ...
            <a href="{{ route('Admin.Game.PackageGroup.JsonExport', $model) }}" class="btn btn-default">JSON出力へ</a>
        </div>
    </div>
@endsection
