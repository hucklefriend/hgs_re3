...
@section('content')
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title">パッケージグループ - JSONから新規作成</h4>
        </div>
        <div class="panel-body">
            <p class="text-muted">
                下記のひな形JSONをAI（ChatGPT・Claude・Geminiなど）に渡し、新規作成したい
                パッケージグループ・パッケージ・ショップの内容を埋めてもらってください。
            ...
            <form method="POST" action="{{ route('Admin.Game.PackageGroup.JsonNewDiff') }}">
                @csrf
        ...
        <div class="panel-footer">
            <a href="{{ route('Admin.Game.PackageGroup') }}" class="btn btn-default"><i class="fas fa-arrow-left"></i> 一覧へ戻る</a>
        </div>
    </div>
@endsection
