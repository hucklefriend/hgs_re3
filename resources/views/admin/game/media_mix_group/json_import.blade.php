...
@section('content')
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('Admin.Game.MediaMixGroup.JsonDiff', $model) }}">
                @csrf
        ...
        <div class="panel-footer">
            ...
            <a href="{{ route('Admin.Game.MediaMixGroup.JsonExport', $model) }}" class="btn btn-default">JSON出力へ</a>
        </div>
    </div>
@endsection
