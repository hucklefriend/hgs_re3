...
@section('content')
    <div class="panel panel-inverse">
        ...
        <form method="POST" action="{{ route('Admin.MasterData.Platform.SyncRelatedProduct', $model) }}">
            @csrf
            ...
            <div class="panel-footer text-end">
                <a href="{{ route('Admin.MasterData.Platform.Detail', $model) }}" class="btn btn-default">Cancel</a>&nbsp;
