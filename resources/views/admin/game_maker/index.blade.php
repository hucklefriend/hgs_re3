...
@section('content')
        ...
        <div class="panel-body">
            <form action="{{ route('Admin>MasterData>Maker') }}" method="GET">
                <div class="row mb-3">
                    ...
                    <div class="col-md-9">
                        {{ Form::text('name', '', ['class' => 'form-control', 'placeholder' => '名前 or よみがな or 略称(半角スペースで単語区切り)', 'autocomplete' => 'off']) }}
                    </div>
                </div>
                <div class="row">
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            <div class="text-end">
                <a href="{{ route('Admin>MasterData>Maker>Add') }}" class="btn btn-default"><i class="fas fa-plus"></i></a>
            </div>
            ...
            <table class="table table-hover">
                ...
                @foreach ($makers as $maker)
                    <tr>
                        ...
                        <td>{{ $maker->name }}</td>
                        <td>{{ $maker->acronym }}</td>
                        <td class="text-center"><a href="{{ route('Admin>MasterData>Maker>Detail', $maker) }}">詳細</a></td>
                    </tr>
                @endforeach
                </tbody>
            </table>
