-- --------------------------------------------------------
-- ホスト:                          127.0.0.1
-- サーバーのバージョン:                   10.11.11-MariaDB-0ubuntu0.24.04.2 - Ubuntu 24.04
...
--  テーブル hgs_re3.cache の構造をダンプしています
...
--  テーブル hgs_re3.cache_locks の構造をダンプしています
...
--  テーブル hgs_re3.failed_jobs の構造をダンプしています
...
--  テーブル hgs_re3.game_franchises の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_franchises` (
  ...
  UNIQUE KEY `key` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=267 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='ゲームフランチャイズデータ';

-- エクスポートするデータが選択されていません

--  テーブル hgs_re3.game_main_network_franchises の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_main_network_franchises` (
...
--  テーブル hgs_re3.game_main_network_params の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_main_network_params` (
...
--  テーブル hgs_re3.game_makers の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_makers` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `key` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=225 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ゲームメーカー情報';

-- エクスポートするデータが選択されていません

--  テーブル hgs_re3.game_maker_package_links の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_maker_package_links` (
...
--  テーブル hgs_re3.game_maker_sites の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_maker_sites` (
...
--  テーブル hgs_re3.game_maker_synonyms の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_maker_synonyms` (
...
--  テーブル hgs_re3.game_media_mixes の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_media_mixes` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL COMMENT '更新日時',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='メディアミックス';

-- エクスポートするデータが選択されていません

--  テーブル hgs_re3.game_media_mix_game_title の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_media_mix_game_title` (
...
--  テーブル hgs_re3.game_media_mix_groups の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_media_mix_groups` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='メディアミックスグループ';

-- エクスポートするデータが選択されていません

--  テーブル hgs_re3.game_media_mix_related_product_links の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_media_mix_related_product_links` (
  `game_media_mix_id` int(10) unsigned NOT NULL COMMENT 'メディアミックスID',
...
--  テーブル hgs_re3.game_official_sites の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_official_sites` (
  `game_title_id` int(10) unsigned NOT NULL COMMENT 'ゲームタイトルID',
...
--  テーブル hgs_re3.game_packages の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_packages` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1495 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ゲームパッケージ';

-- エクスポートするデータが選択されていません

--  テーブル hgs_re3.game_package_groups の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_package_groups` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=241 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='パッケージグループ';

-- エクスポートするデータが選択されていません

--  テーブル hgs_re3.game_package_group_package_links の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_package_group_package_links` (
...
--  テーブル hgs_re3.game_package_sample_images の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_package_sample_images` (
  `game_package_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'パッケージID',
...
--  テーブル hgs_re3.game_package_shops の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_package_shops` (
...
) ENGINE=InnoDB AUTO_INCREMENT=1781 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ゲームパッケージとショップの紐づけ';

-- エクスポートするデータが選択されていません

--  テーブル hgs_re3.game_platforms の構造をダンプしています
...
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ゲームプラットフォーム';

-- エクスポートするデータが選択されていません

--  テーブル hgs_re3.game_platform_related_product_links の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_platform_related_product_links` (
  `game_platform_id` int(10) unsigned NOT NULL COMMENT 'プラットフォームID',
  `game_related_product_id` int(10) unsigned NOT NULL COMMENT '関連商品ID',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
--  テーブル hgs_re3.game_platform_sites の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_platform_sites` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `game_platform_id` int(10) unsigned NOT NULL COMMENT 'プラットフォームID',
  `node_name` varchar(200) NOT NULL COMMENT 'ノード表示用名称',
  `url` text NOT NULL COMMENT 'URL',
...
--  テーブル hgs_re3.game_platform_synonyms の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_platform_synonyms` (
...
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='ゲームプラットフォームの俗称';

-- エクスポートするデータが選択されていません

--  テーブル hgs_re3.game_related_products の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_related_products` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL COMMENT '更新日時',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=185 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='関連商品';

-- エクスポートするデータが選択されていません

--  テーブル hgs_re3.game_related_product_shops の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_related_product_shops` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `game_related_product_id` int(10) unsigned NOT NULL COMMENT '関連商品ID',
  `shop_id` int(10) unsigned NOT NULL COMMENT 'ショップID',
  `url` text NOT NULL COMMENT 'URL',
...
) ENGINE=InnoDB AUTO_INCREMENT=294 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='関連商品とショップ紐づけ';

-- エクスポートするデータが選択されていません

--  テーブル hgs_re3.game_series の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_series` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=92 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ゲームシリーズ';

-- エクスポートするデータが選択されていません

--  テーブル hgs_re3.game_titles の構造をダンプしています
...
) ENGINE=InnoDB AUTO_INCREMENT=439 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ゲームタイトル';

-- エクスポートするデータが選択されていません

--  テーブル hgs_re3.game_title_package_group_links の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_title_package_group_links` (
  `game_title_id` int(10) unsigned NOT NULL COMMENT 'ゲームタイトルID',
...
--  テーブル hgs_re3.game_title_package_links の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_title_package_links` (
  `game_title_id` int(10) unsigned NOT NULL COMMENT 'ゲームタイトルID',
  `game_package_id` int(10) unsigned NOT NULL COMMENT 'パッケージID',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
--  テーブル hgs_re3.game_title_related_product_links の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_title_related_product_links` (
...
--  テーブル hgs_re3.game_title_synonyms の構造をダンプしています
CREATE TABLE IF NOT EXISTS `game_title_synonyms` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `synonym` (`synonym`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=173 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='ゲームタイトルの俗称';

-- エクスポートするデータが選択されていません

--  テーブル hgs_re3.information の構造をダンプしています
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='お知らせ';

-- エクスポートするデータが選択されていません

--  テーブル hgs_re3.jobs の構造をダンプしています
...
--  テーブル hgs_re3.job_batches の構造をダンプしています
...
--  テーブル hgs_re3.migrations の構造をダンプしています
...
--  テーブル hgs_re3.ogp_caches の構造をダンプしています
CREATE TABLE IF NOT EXISTS `ogp_caches` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=310 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='OGP情報のキャッシュ';

-- エクスポートするデータが選択されていません

--  テーブル hgs_re3.password_reset_tokens の構造をダンプしています
...
--  テーブル hgs_re3.sessions の構造をダンプしています
...
--  テーブル hgs_re3.tags の構造をダンプしています
...
--  テーブル hgs_re3.users の構造をダンプしています
